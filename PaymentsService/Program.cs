...
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection") 
    ...
    ?? "Server=localhost;Database=PaymentsDb;User Id=sa;Password=YourStrong@Passw0rd;TrustServerCertificate=True;";
...
_ = Task.Run(() => messageConsumer.StartConsumingAsync("order_payments", cancellationTokenSource.Token));
